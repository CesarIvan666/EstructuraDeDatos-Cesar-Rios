...
/**
 * Clase Main que contiene el punto de entrada del programa para probar los métodos implementados.
 */
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int target = 11;
        int indexIterative = BinarySearch.iterativeBinarySearch(sortedArray, target);
        int indexRecursive = BinarySearch.recursiveBinarySearch(sortedArray, target, 0, sortedArray.length - 1);
